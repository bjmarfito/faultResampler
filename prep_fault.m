...
% 3. Vertices should be a (2x2) matrix with the first row containing the x-coordinates (longitude) while the second row containing the y-coordinates (latitude).
